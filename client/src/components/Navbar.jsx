...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex md:justify-content-center justify-between items-center p-4">
            ...
            {toggleMenu && (
                <ul className="
                z-10 fixed top-0 -right-2 p-3 w-[70vw] h-screen shadow-2x1 md:hidden list-none flex flex-col justify-start items-end rounded-md blue-glassmorphism
